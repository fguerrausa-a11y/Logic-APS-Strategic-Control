  ...
  return (
    <div className="flex flex-col gap-1 rounded-xl p-5 border border-[var(--border-color)] bg-[var(--bg-card)] relative overflow-hidden group">
      <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
        <span className="material-symbols-outlined text-4xl text-[var(--accent)]">{icon}</span>
      </div>
      ...
      <div className="flex items-center gap-1 mt-2">
        <span className={`material-symbols-outlined text-sm ${trendPositive ? 'text-emerald-500' : 'text-rose-500'}`}>
