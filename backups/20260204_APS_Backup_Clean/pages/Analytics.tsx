    ...
    return (
        <div className="flex h-screen overflow-hidden bg-[var(--bg-main)] text-[var(--text-main)] font-body transition-colors">
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden relative">
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-10 bg-grid-white/[0.01]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { label: 'Mean Time to Repair (MTTR)', value: '1.2h', icon: <Zap size={20} className="text-amber-500" /> },
                            { label: 'Mean Time Between Failures', value: '142h', icon: <Activity size={20} className="text-emerald-500" /> },
                            { label: 'Scrap Rate', value: '1.4%', icon: <ArrowDownRight size={20} className="text-rose-500" /> },
                            { label: 'Cycle Time Variance', value: '-0.3s', icon: <TrendingUp size={20} className="text-indigo-500" /> },
                        ].map((stat, i) => (
