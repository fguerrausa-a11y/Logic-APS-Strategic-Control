...
import StrategyCalibration from './pages/StrategyCalibration.tsx';
import EngineCertification from './pages/EngineCertification.tsx';
  ...
  return (
    <LanguageProvider>
      <SimulationProvider>
        <HashRouter>
          <Routes>
            {/* Auth route stays outside the layout if it has its own sidebar/design */}
            ...
            <Route element={<MainLayout />}>
              ...
              <Route path="/calibration" element={<StrategyCalibration />} />
              <Route path="/certification" element={<EngineCertification />} />
            </Route>
